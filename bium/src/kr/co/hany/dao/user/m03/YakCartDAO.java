...
public class YakCartDAO  extends DefaultDAO{
	...
	public boolean add_order_card( CommonMap param
		...
		try {
			...
			for(int i = 0; i< list.size(); i++) {
				...
				param.put("sale_price"  , info.get("sale_price"));
				param.put("order_id"    , param.getString("id"));
				
				
				param.put("box_option_price"  , info.get("box_option_price"));
				param.put("box_option_nm"  	  , info.get("box_option_nm"));
				param.put("box_option_seqno"  , info.get("box_option_seqno"));
	...
	@SuppressWarnings("unchecked")
	public Map<String, Object> select_cmspay_info(CommonMap param)throws Exception{
		return (Map<String, Object>)sqlSession.selectOne(NAMEPSACE+"select_cmspay_info", param);
	}
	
	@SuppressWarnings("unchecked")
	public Map<String, Object> select_cmspay_info_last(CommonMap param)throws Exception{
		return (Map<String, Object>)sqlSession.selectOne(NAMEPSACE+"select_cmspay_info_last", param);
	}
