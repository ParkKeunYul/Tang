...
<div id="container">	
	...
	<div id="contents_order">
		...
		<div class="LArea">
			...
			<!-- 처방내용 입력 -->
			<div class="div_tit mt30">처방내용<span class="fc06">(처방은 1첩분량 기준입니다.)</span></div>
					...
					<tr>
						...
						<td colspan="3" class="pt15">
							...
							<p class="comment01" id="jusu_txt"  style="display:none;">
								<input type="checkbox" name="c_tang_check13" <c:if test="${setting.c_tang_check13 eq 'y' }">checked="checked"</c:if>  id="c_tang_check13"   readonly="readonly" value="y" attr="12000" /> <span class="b"><label for="c_tang_check13">주수상반</label> </span>
								* 물과 술을 1:1비율로 넣고 약을 달입니다.
								<c:choose>
									<c:when test="${userInfo.mem_sub_grade eq 2}">
										(+***,***)
									</c:when>
			...
			<div class="order_option">
				...
				<div class="dictionary order_detail" id="orderOp1" style="display:none;">
					...
					<div class="list_popup01" id="list_popup01" style="display:none ;">
						...
						<p class="tit">처방설명 <a href="#" id="dic_pop_detail"><img src="/assets/user/images/sub/btn_view.png" alt="상세보기" /></a></p>
						<table class="poplist">
							<colgroup>
								<col width="80px" />
								<col width="*" />
				...
				<div class="my_dictionary order_detail"  id="orderOp2" style="display:none;">
					...
					<div class="list_popup01" id="list_popup02" style="display:none ;">					
						...
						<p class="tit">처방설명 <a href="#" id="mydic_pop_detail"><img src="/assets/user/images/sub/btn_view.png" alt="상세보기" /></a></p>
						<table class="poplist">
							<colgroup>
								<col width="80px" />
								<col width="*" />
			...
			<div class="deliver">
				<p class="tit">
					...
					<select name="d_type" id="d_type"  style="width:330px;margin-left:10px;">
						...
						<option value="1" <c:if test="${setting.d_type eq 1 }">selected="selected"</c:if>>원외탕전 → 한의원</option>
						<option value="4" <c:if test="${setting.d_type eq 4 }">selected="selected"</c:if>>원외탕전 → 환자</option>
						<option value="3" <c:if test="${setting.d_type eq 3 }">selected="selected"</c:if>>한의원 → 환자</option>
				...
				<div class="receive" style="position: relative;">
					...
					<ul>
						...
						<li>
							<span class="dI H40">
								<input type="text" name="d_to_zipcode" id="d_to_zipcode01" value="${setting.d_to_zipcode}"  style="width:180px;" readonly><a href="#" id="addrBtn2" ><span id="" class="h34 cB">주소찾기</span></a>
