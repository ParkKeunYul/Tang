...
<div id="container">
	...
	<div id="contents">
		...
		<div class="titArea">
			<p class="Ltit">방제사전</p>
			<p>대표 처방집의 다양한 처방정보를 제공합니다.<br/>나의 처방으로 등록 하시면 <font class="fc01 b">"마이페이지 > 나의처방 관리"</font> 에서 등록 하신 처방전을 수정 하실 수 있습니다.</p>
		</div>
		<!-- // 서브타이틀 -->
		<!-- 내용 -->
		<div class="conArea">
			...
			<div class="searchArea">
				<form action="" method="get" name="frm" id="frm">
					<select name="search_title" id="search_title"  style="width:150px;float:left;">
					...
					<div class="inputL">
						<input type="text" placeholder="통합검색" style="width:280px;" name="search_value" id="search_value" value="${bean.search_value}" />
						<a href="#"><img src="/assets/user/images/common/bg_search.png" alt="검색" class="mt8" id="searchDicBtn" /></a>
					</div>
