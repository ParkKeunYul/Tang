	...
	<div id="contents">
		...
		<div class="conArea">
				...
				<div>
					...
					<ul>
						...
						<li>
							...
							<span class="dI H40">
								<input type="text" name="o_zipcode" id="o_zipcode" style="width:150px;" readonly><a href="#" id="findAddrBtn1" ><span id="addrBtn1" class="h34 cB">주소찾기</span></a>
							</span>
							<span class="dI">
				...
				<div class="ml60" style="position: relative;">
					...
					<ul>
						...
						<li>
							<span class="tit">주소</span>
							<span class="dI H40">
								<input type="text" name="r_zipcode" id="r_zipcode" style="width:150px;" readonly><a href="#" id="findAddrBtn2"><span id="addrBtn1" class="h34 cB">주소찾기</span></a>
								<a href="#" id="latelyBtn"><span id="" class="h34 cB">최근배송지</span></a>
								<!-- 190930 추가
								<a href="#" onclick="window.open('before_del.html','window팝업','width=850, height=520, menubar=no, status=no, toolbar=no');"><span id="addrBtn1" class="h34 cBg">최근배송정보</span></a>
								-->
							</span>
							<span class="dI">
			...
			<!-- btnarea -->
				...
				<input type="hidden" name="search_sub_seqno" value="${bean.search_sub_seqno}" />
