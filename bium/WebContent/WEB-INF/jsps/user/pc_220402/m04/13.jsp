...
<script>
	...
	<div class="contents">
		...
		<p class="subtit_top">기본을 지키며 신뢰로 다가가는 비움환 원외탕전이 되겠습니다.<span>처방내역</span></p>
		<ul class="submenu w33">
			<li><a href="/m04/11.do" class="">논문</a></li>
			<li><a href="/m04/12.do" class="">통계자료</a></li>
			<li><a href="/m04/13.do" class="sel">처방내역</a></li>
		</ul>
			...
			<tbody>
				<c:forEach var="list" items="${nlist}">
					<tr>
						<td>공지</td>
						<td class="L top">
							<a href="13_view.do?seq=${list.seq}&board_name=${bean.board_name}&page=${bean.page}&search_title=${bean.search_title}&search_value=${bean.encodeSV}">
								${list.title}
							</a>
