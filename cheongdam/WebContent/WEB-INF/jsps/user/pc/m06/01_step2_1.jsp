	...
	<script type="text/javascript">
		...
		<div class="banner">
			...
			<p class="txtarea">
				...
				자세한 내용은 Tel.054-242-1079로 문의 주시기 바랍니다.
			</p>
		</div>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<span class="dI">
									<input type="text" name="address01" style="width:400px;" readonly id="address01"><br/>
									<input type="text" name="address02" style="width:250px;" id="address02">
									<input type="checkbox" id="set_addr" style="vertical-align: middle;" />
									<label for="set_addr" class="t01" style="margin-left: 0px;">(의료기관 주소 입력)</label>  
								</span>
							</td>
						</tr>
						<tr>
