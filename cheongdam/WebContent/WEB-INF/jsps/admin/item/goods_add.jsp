	...
	<table class="basic01">
		...
		<tbody>
			<tr>
				...
				<th>분류</th>
				<td class="tdL">
					<select name="p_bigpart" id="p_bigpart" style="min-width: 400px;">
			...
			<tr>
				<th>상품상세</th>
				<td colspan="3" class="tdL"><textarea name=p_contents id="p_contents" style="height:400px;" cols=103>${info.p_contents}</textarea></td>
			</tr>
			<tr>
				<th>상품사진1	</th>
