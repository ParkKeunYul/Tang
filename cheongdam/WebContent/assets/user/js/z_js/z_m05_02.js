$(document).ready(function() {
	$("#cartGrid").jqGrid({
  		...
  		colModel:[
  			...
  			{name:'order_type',		index:'order_type',		width:10,	align:"center"  , hidden:true}
  		],
		...
		onCellSelect : function(row,iCol,cellcontent,e){
			...
			if(iCol == 3){
				...
				//	location.href='/m02/02_cart_update.do?cart_seqno='+data.seqno;
				}else{
				}
			}
		},
