						...
						<tr>
							<td colspan="6" class="totalBoxfoot">
								<ul class="fr">
									...
									<li class="Bt02">배송비<span class="won" style="color: red;">- <fmt:formatNumber value="${delivery_price-member_sale}" pattern="#,###원" /></span></li>
									<li class="total">합계<span class="won"><fmt:formatNumber value="${sum1 - delivery_price + member_sale}" pattern="#,###원" /></span></li>
								</ul>
							</td>
						</tr>
					</tfoot>
