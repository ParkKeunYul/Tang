...
<div id="container">
	...
	<%
		...
		*/
		...
		String moid             = Const.NP_moid+"t"+(String.format("%08d", StringUtil.ObjectToInt(bean.get("seqno"))))+"_"+sdf.format(today);              // 상품주문번호      
	...
	<div id="contents">
		...
		<div class="sub_gnb">
			...
			<p class="sg"><span>탕전처방</span><span>장바구니</span></p>
		</div>
		...
		<!-- 내용 -->
		<div class="conArea">
			<form action="/m05/02_cart_order_com.do" name="frm" id="frm">
				<!-- cartview -->
				<table class="cart_list" style="margin-top:0px;">
					<colgroup>
						<col width="120px" />
						<col width="140px" />
						<col width="*" />
					...
					<tbody>
						...
						<c:forEach var="list" items="${list}">
							...
							<tr>
								...
								<td class="R fc01_t"><fmt:formatNumber value="${list.order_total_price}" pattern="#,###원" /></td>
								<td>
									<c:choose>
					...
					<tfoot>
						<tr>
							<td colspan="5" class="totalBoxfoot">
								<ul class="fr">
				...
				<div id="nice_pay_setting_area" style="display: ;">
					<input type="hidden" name="PayMethod"   value="CARD">
					<input type="hidden" name="GoodsName"   value="<%=goodsName%>"> <!-- 상품명 -->
					<input type="hidden" name="GoodsCnt"    value="<%=goodsCnt%>"> <!-- 상품겟수 -->
					<input type="hidden" name="Amt"         value="${sum1}"> <!-- 결제금액 -->
					<input type="hidden" name="BuyerName"   value="${userInfo.name}">
