$(document).ready(function() {
  	...
  	//	caption : '택배사 정보',
  		...
  		//rowList: [3],
  		colNames:[
  			'번호', '택배사영', '가격','기본택배(한개만 지정가능)','사용여부','조회코드', 
  			'등록일', 
  		],
  		colModel:[
  			{name:'seqno',		index:'a_seqno',	width:48,	align:"center"  ,sortable : false ,key: true },
  			{name:'delivery_nm',index:'delivery_nm',width:120,	align:"left" 	,sortable : false },
  			...
  			{name:'use_yn',		index:'use_yn',		width:120,	align:"center"  ,sortable : false 
  				,editable:true
  				,edittype:"select"
  				,formatter: 'select'
  				,editoptions:{
