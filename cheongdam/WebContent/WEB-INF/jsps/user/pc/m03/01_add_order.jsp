...
<div id="container">
	...
	<div id="contents">
		...
		<form action="01_com_order.do" name="frm" id="frm">
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="3">
								...
								<div class="lately_wrap" style="position: absolute;width: 850px;min-height: 520px;z-index: 9999;background: #fff;top: 640px;left: 90px;border: 1px solid #26995d;display: none;"></div>
							</td>
						</tr>
						<tr>
							<th>배송메모</th>
