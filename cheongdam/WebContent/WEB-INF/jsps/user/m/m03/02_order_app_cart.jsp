...
<div class="container sub" id="contents">
	...
	<!-- <form name="payForm" id="payForm" method="post" target="_self" action="https://web.nicepay.co.kr/v3/smart/smartPayment.jsp" accept-charset="euc-kr"> -->
			...
			<div class="orderview">				
				...
				<div class="Listbox mt10">
					...
					<ul>
						...
						<li class="type02">
							<label class="title" for="o_handphone01">연락처2</label>
							<div>
				...
				<div class="Listbox">
					...
					<ul>
						...
						<li class="type02">
							<label class="title" for="r_handphone01">연락처2</label>
							<div>
		...
		<input type="hidden"  name="reason" id="reason" value="약속처방 장바구니 구매 포인트 사용"/>
