				...
				<tbody>
					<tr>
						...
						<td class="L instyle">
							...
							<label><input type="checkbox"  name="base_yn" id="joje_base_yn" readonly="readonly" /><a href="#" id="jojeBaseBtn"> <span class="cBB h30">기본설정으로 등록</span></a></label>
						</td>
					</tr>
					<tr>
						<th>내용</th>
						<td class="L instyle">
							<textarea name="" readonly="readonly" id="joje_contents" style="width:850px; height:80px;resize:none;"></textarea>
						</td>
					</tr>
				</tbody>
			</table>
				...
				<tbody>
					<tr>
						...
						<td class="L instyle">
							...
							<label><input type="checkbox" id="bok_base_yn" /><a href="#" id="bokBaseBtn"> <span class="cBB h30">기본설정으로 등록</span></a></label>
						</td>
					</tr>
					<tr>
						<th>내용</th>
						<td class="L instyle">
							<textarea name="" id="bok_contents" style="width:850px; height:80px;resize:none;" readonly="readonly"></textarea>
						</td>
					</tr>
				</tbody>
			</table>
