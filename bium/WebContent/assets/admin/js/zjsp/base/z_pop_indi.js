...
$(document).ready(function() {
  	...
  	//	caption : '개인공지팝업',
  		...
  		colNames:[
  			'번호'     , '이름'    , '아이디'  , '제목'      , '이미지'  , 
  			'시작일'   , '종료일'   ,'가로크기'  , '세로크기'   ,'Top 여백', 
  			'Left여백' ,'활성화'   ,'타겟'     , '링크'      , 'han_name',
  			'content'
  			
  		],
  		colModel:[
  			{name:'seqno',		index:'seqno',		width:28,	align:"center" ,key: true },
  			{name:'name',		index:'name',		width:88,	align:"left"},
  			{name:'id',			index:'id',			width:88,	align:"left"},
  			{name:'title',		index:'title',		width:358,	align:"left"},
  			{name:'upfile',		index:'upfile',		width:100,	align:"center", formatter: getImgSrc ,hidden:true},
  			...
  			{name:'han_name',		index:'han_name',		width:358,	align:"left"  , hidden:true},
  			{name:'CONTENT',		index:'CONTENT',		width:358,	align:"left" , hidden:true }
  		],
		pager: "#jqGridControl",
		viewrecords: true,
		autowidth: true,
