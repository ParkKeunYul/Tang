...
public class ItemDAO extends DefaultDAO{
	...
	@SuppressWarnings("unchecked")
	public List<Map<String, Object>> select_p_pouch(CommonMap param)throws Exception{
		return sqlSession.selectList(NAMEPSACE+"select_p_pouch", param);
	}
	
	@SuppressWarnings("unchecked")
	public List<Map<String, Object>> select_p_box(CommonMap param)throws Exception{
		return sqlSession.selectList(NAMEPSACE+"select_p_box", param);
	}
