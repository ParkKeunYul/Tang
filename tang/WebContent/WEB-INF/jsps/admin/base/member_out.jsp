...
$(document).ready(function() {
  	...
  	$("#jqGrid").jqGrid({
  		...
  		datatype: "local", 
  		url : '/admin/base/member/out_select.do',
  		datatype: 'json',
  		hidegrid: false,
  		width: "100%",
  		height: "100%",
  		...
  		colModel:[
  			...
  			{name:'group_code',		index:'group_code',		width:150,	align:"center"  ,sortable : true , hidden:true
  				,editable:true
  				,edittype:'select'
  				,formatter: 'select'
  				,editoptions:{
...
function closeDaumPostcode(){
	...
	<div class="con_tit">기본관리 &gt; 탈퇴회원관리</div>
	...
	<div class="conBox">
		<div class="inputArea disB">
			...
			<a href="#" id="restore_btn" class="btn03" style="color: red !important;">회원 복구</a>
		</div>
