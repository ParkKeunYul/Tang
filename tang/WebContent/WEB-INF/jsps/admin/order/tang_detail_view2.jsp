...
<div id="idPrint">
	...
	<table class="basic01">
        <tr> 
          <td width="270"><font color="#333333">▶ 탕전주문내역서</font></td>
          <td style="text-align:right;padding: 0 0 ;">
          	<table width="528" border="1" cellpadding="0" cellspacing="1"  class="">
              <tr> 
                <td width="40" rowspan="2" align="center" ><font color="#333333">결 재</font><br> </td>
                <td width="63" height="25" align="center" ><font color="#333333">접수</font></td>
                <td width="63" align="center" ><font color="#333333">조제</font></td>
				<td width="63" align="center" ><font color="#333333">확인</font></td>
                <td width="63" align="center" ><font color="#333333">탕전</font></td>
				<td width="63" align="center" ><font color="#333333">이송</font></td>
				<td width="63" align="center" ><font color="#333333">포장</font></td>
                <td width="63" align="center" ><font color="#333333">발송</font></td>
              </tr>
              <tr> 
                <td height="50" >&nbsp;</td>
                <td >&nbsp;</td>
	...
	<form name="form" method=post>
		<table class="basic01" style="border-top:none;margin-top:0px;">
		  ...
		  <tr> 
		    <td align="center" class="add_th" ><font color="#333333">회원명(처방자)<br></font></td>
		    <td width="170"  class="tdL"><font color="#333333">${info.name}</font></td>
		    <td align="center"  class="add_th" ><font color="#333333">한의원명</font></td>
		    <td width="170" class="tdL"><font color="#333333">${info.han_name }</font></td>
		  </tr>
		  
		  <tr> 
		    <td align="center"  class="add_th"><font color="#333333">복용자</font></td>
		    <td width="170"  class="tdL" ><font color="#333333">${info.w_name}</font></td>
		    <td align="center" class="add_th" ><font color="#333333">성별/나이</font></td>
		    <td  width="170"class="tdL"  ><font color="#333333">${info.w_sex_nm} / ${info.w_age}</font></td>
		  </tr>
		  
		  <tr> 
		    <td align="center"  class="add_th"><font color="#333333">주문번호</font></td>
		    <td class="tdL"><font color="#333333">${info.order_no}</font><br></td>
		    <td align="center" class="add_th" ><font color="#333333">주문날짜</font></td>
		    <td class="tdL"><font color="#333333">${info.order_date2}</font></td>
		  </tr>
		  
		  <tr> 
		    <td align="center"  class="add_th"><font color="#333333">주문상품</font></td>
		    <td colspan="3"  class="tdL"><font color="#333333">[${info.s_name} ]</font></td>
		  </tr>
		  
		  <tr> 
		    <td align="center" class="add_th" ><font color="#333333">첩수</font></td>
		    <td class="tdL">
		    	<font color="#333333">
		    ...
		    <td align="center" class="add_th" ><font color="#333333">파우치 용량<br></font></td>
		    <td class="tdL"><font color="#333333">${info.c_pack_ml}ml</font></td>
		  </tr>
		  
		  <tr> 
		    <td align="center"  class="add_th"><font color="#333333">팩수<br></font></td>
		    <td class="tdL"><font color="#333333">${info.c_pack_ea}</font></td>
		    <td align="center"  class="add_th"><font color="#333333">묶음배송<br></font></td>
		    <td class="tdL"  >
		    	<font color="#333333">
		  ...
		  <tr> 
		    <td align="center" class="add_th" ><font color="#333333">탕전방식<br></font></td>
		    <td class="tdL"><font color="#333333">${info.c_tang_type_nm}</font></td>
		    <td align="center"  class="add_th"><font color="#333333">배송비</font></td>
		    <td class="tdL">
		  ...
		  <tr> 
		    <td  class="add_th">
		    	<font color="#333333">
		    		<c:choose>
						<c:when test="${info.c_tang_check15 eq 'y' }">발효</c:when>
						<c:when test="${info.c_tang_check14 eq 'y' }">증류</c:when>
						<c:when test="${info.c_tang_check16 eq 'y' }">재탕</c:when>
						<c:otherwise>
							주수상반
						</c:otherwise>
					</c:choose>
		    ...
		    <td align="center"  class="add_th" ><font color="#333333">스티로폼포장</font></td>
		    <td class="tdL" ><font color="#333333"><font color=blue>${info.c_stpom_type_nm}</font></font></td>
		  </tr>
		  
		  <tr> 
		    <td align="center"  class="add_th"><font color="#333333">박스포장/수량</font></td>
		    <td class="tdL">
		    	<font color="#333333">
		    		${info.c_box_type_nm} / 
		    ...
		    <td align="center" class="add_th" ><font color="#333333">파우치포장</font></td>
		    ...
		    <td colspan="4"  valign=top  style="padding:0 0 ;">
		    	<table width="100%" border="1" class="tb1">
	              <tr> 
	                ...
	                <td width="60" align="center"  class="add_th"  ><font color="#333333">위치</font></td>
		  ...
		  <tr> 
		    <td  align="center"  class="add_th" ><font color="#333333">조제지시사항</font></td>
		  ...
		  <tr> 
		    <td  align="center"  class="add_th" ><font color="#333333">조제첨부파일</font></td>
		    <td  colspan="3"  class="tdL" >
		  ...
		  <tr> 
		    <td  align="center"  class="add_th" ><font color="#333333">복용법<br></font></td>
		    <td  colspan="3" class="tdL"  >
		  ...
		  <tr> 
		    <td  align="center"  class="add_th"><font color="#333333">복용첨부파일<br></font></td>
		    <td  colspan="3" class="tdL" >
		  ...
		  <tr> 
		    <td  align="center"  class="add_th"><font color="#333333">발송정보<br></font></td>
		    <td  colspan="3"  class="tdL">
		    	<font color="#333333">
		  ...
		  <tr> 
		    <td  align="center"  class="add_th"><font color="#333333">배송정보<br></font></td>
		    <td  colspan="3" class="tdL" >
		    	<font color="#333333">
		  ...
		  <tr> 
		    <td align="center"  class="add_th"><font color="#333333">배송시메모<br></font></td>
		    <td colspan="3"class="tdL"  ><font color="#333333">${info.d_to_contents}</font></td>
		  </tr>
		  
		  <tr> 
		    <td  align="center"  class="add_th"><font color="#333333">주문시요청사항<br></font></th>
		    <td  colspan="3" class="tdL" ><font color="#333333">${info.d_to_contents2}</font></td>
		  </tr>
		  
		  <tr> 
		    <td align="center"  class="add_th" ><font color="#333333">관리자메모 </font></td>
