...
<div id="container">
	...
	<%
		...
		*******************************************************
		*/
		String encodeKey		= "EYzu8jGGMfqaDEp76gSckuvnaHHu+bC4opsSN6lHv3b2lurNYkVXrZ7Z1AoqQnXI3eLuaUFyoRNC6FkrzVjceg==";   // 상점키
		        ...
		        <div class="con">
		          <div class="tabletypea">
		            <table>
					  ...
					  <tr>
					    <th><span>가상계좌입금만료일</span></th>
						<td><input type="text" name="VbankExpDate" value=""/></td>                <!-- 가상계좌 결제 시 필수 값입니다 -->
					  </tr>
