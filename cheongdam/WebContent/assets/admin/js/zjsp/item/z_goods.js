$(document).ready(function() {
	  	...
	  	$("#jqGrid").jqGrid({
			...
			sortorder: "desc",
	  		colNames:[
	  			'번호'  , '번호'  ,'상품명'  ,'판매가'  , '처방상태' ,'메인노출' , 
	  			'황성화','사전지시서', '정렬' ,'등록일'
	  		],
	  		colModel:[
	  			{name:'a_num',			index:'a_num',		width:58,	align:"center"  ,sortable : false  },
	  			{name:'p_seq',		index:'p_seq',		width:48,	align:"center"  ,sortable : false ,key: true  , hidden:true},
	  			{name:'p_name',		index:'p_name',		width:420,	align:"left"  ,sortable : true ,editable:false},
	  			{name:'p_price',	index:'p_price',	width:120,	align:"right"  ,sortable : true 
	  				,editable:true
	  				,formatter: 'integer'
	  				,formatoptions:{thousandsSeparator:","}
	  			},
	  			{name:'p_ea',		index:'p_ea',		width:120,	align:"center"  ,sortable : true
	  				,editable:true 
	  				,edittype:"select"
	  				,editoptions:{
	  			...
	  			{name:'main_yn',	index:'main_yn',	width:120,	align:"center"  ,sortable : true
	  				,editable:true 
	  				,edittype:"select"
	  				,editoptions:{
	  					 value:"y:노출;n:미노출"  						
	  			...
	  			{name:'view_yn',	index:'view_yn',	width:120,	align:"center"  ,sortable : true
	  				,editable:true 
	  				,edittype:"select"
	  				,editoptions:{
	  					 value:"y:활성;n:비활성"  						
	  			...
	  			{name:'pre_req',	index:'pre_req',	width:100,	align:"center"  ,sortable : true
	  				,editable:true 
	  				,edittype:"select"
	  				,editoptions:{
	  					 value:"Y:활성;N:비활성"  						
	  			...
	  			{name:'sort_seq',	index:'sort_seq',	width:60,	align:"right"  ,sortable : true 
	  				,editable:true
	  				,formatter: 'integer'
	  				,formatoptions:{thousandsSeparator:","}
	  			},
