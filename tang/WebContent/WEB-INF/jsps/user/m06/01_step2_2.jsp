...
<div id="container">
	...
	<div id="contents">
		...
		<div class="titArea2">
			<p class="Ltit">정보입력</p>
			<p>
				<span>한의사(일반) 으로 회원가입을 진행합니다.</span><br/>
				공동탕전실은 의료기관의 부설시설로 의료기관에 소속된 한의사만이 처방을 의뢰할 수 있으며 의약품의 도매 및 소매는 한방의료기관 및 약국개설자와<br/>
				그 외 법에서 인정하는 경우에만 허용이 됩니다. 한의사 면허증을 보내주셔야 회원가입이 완료됩니다.<br/>자세한 내용은 전화로 문의하세요. tel) 043.731.5075
			</p>
		</div>
		<!-- // 서브타이틀 -->
		<!-- 내용 -->
