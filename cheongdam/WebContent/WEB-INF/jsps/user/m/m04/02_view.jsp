...
<div class="container sub" id="contents">
	...
	<div class="contents" id="contents">
		<div class="commView">
			...
			<div class="btnArea">
				<a href="02.do?page=${bean.page}&search_title=${bean.search_title}&search_value=${bean.encodeSV}" class="btnTypeBasic colorGray"><span>목록보기</span></a>
			</div>
			<div class="prevNext">
				<p class="next">
					<b>다음글  </b>
