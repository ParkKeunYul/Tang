...
public interface LoginDAO {
	...
	public void updateCmsKey(@Param("info") Map<String, Object>info);
	
	public void saveCmsPayInfo(@Param("info") Map<String, Object>info);
	
	
	public Map<String, Object> userGetInfo(@Param("param") CommonMap param);
}
