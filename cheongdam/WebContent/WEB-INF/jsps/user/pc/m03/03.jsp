...
<div id="container">
	...
	<div id="contents">
		<div class="sub_gnb">
			...
			<p class="sg"><span>약속처방</span><span>사전조제지시서 관리</span></p>
		</div>

		<ul class="sub_Menu w33">
			<li><a href="01.do">약속처방</a></li>
			<li><a href="02.do">약속처방 보관함</a></li>
			<li class="sel"><a href="03.do">사전조제지시서 관리</a></li>
		</ul>
			...
			<tbody>
				<c:forEach var="list" items="${list}">
					<tr>
						...
						<td><a href="#" onclick="window.open('01_preorder.do?p_seq=${list.goods_seqno}','사전조제지시','width=700, height=570, menubar=no, status=no, toolbar=no');"><span class="cO h25">추가하기</span></a></td>
