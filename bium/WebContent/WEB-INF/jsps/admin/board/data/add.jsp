			...
			<tr>
				...
				<td class="tdL">
					<select name="cate_nm" id="cate_nm">
						<option value="1"  <c:if test="${add_bean.cate_nm eq '1' }"> selected="selected"</c:if>>통계자료</option>
						<option value="2"  <c:if test="${add_bean.cate_nm eq '2' }"> selected="selected"</c:if>>비만자료</option>
						<option value="3" <c:if test="${add_bean.cate_nm eq '3' }"> selected="selected"</c:if>>비움환처방</option>
