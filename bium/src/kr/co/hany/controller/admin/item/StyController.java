...
import kr.co.hany.dao.admin.item.StyDAO;
...
@Controller
@RequestMapping(value="/admin/item/sty/*")
public class StyController extends AdminDefaultController{
	...
	public @ResponseBody JsonObj  select_group( Map<String, Object> map
		...
		try{
			...
			if( param.getInt("total")  > 0 ) {
				jsonObj.setRows(styDao.select(param));
			}
	...
	public String add( Map<String, Object> map
		...
		return "/item/sty_add"+Const.uaTiles;
	}
	...
	public @ResponseBody Map<String, Object> add_proc( Map<String, Object> map
		...
		try {
			...
			String tempPath  = Const.UPLOAD_ROOT+ "sty/temp/";
			int next_seqno   = styDao.select_next_seqno();
			String folder_nm = "sty";
	...
	public @ResponseBody Map<String, Object> mod_proc( Map<String, Object> map
		...
		try {
			...
			Map<String, Object> file_info1 = FileUploadUtil.getAttachFiles(requests, "image1", tempPath, "");
			param  = FileUploadUtil.getAttachFilesDbSet(param, file_info1, tempPath, now_seqno, 1,"image1",folder_nm);
			
			Map<String, Object> file_info2 = FileUploadUtil.getAttachFiles(requests, "image2", tempPath, "");
			param  = FileUploadUtil.getAttachFilesDbSet(param, file_info2, tempPath, now_seqno,2, "image2",folder_nm);
			
			Map<String, Object> file_info3 = FileUploadUtil.getAttachFiles(requests, "image3", tempPath, "");
			param  = FileUploadUtil.getAttachFilesDbSet(param, file_info3, tempPath, now_seqno,3, "image3",folder_nm);
