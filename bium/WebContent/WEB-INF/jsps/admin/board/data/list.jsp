...
$(document).ready(function() {
  	...
  	$("#jqGrid").jqGrid({
  		...
  		colModel:[
  			...
  			{name:'notice_yn',	index:'notice_yn',		width:98,	align:"center" 
  				,editable:true 
  				,edittype:"select"
  				,editoptions:{
  					value:"y:공지함;n:공지안함"
  			...
  			{name:'cate_nm',	index:'cate_nm',		width:120,	align:"center" 
  				,edittype:"select"
  				,editoptions:{
  					value:"1:통계자료;2:비만자료;3:비음환처방;99:기타"
  					/* 
  					,dataEvents: [{type: 'change', fn: function(e){
  						update_payment(this);}
                	}]
...
<div class="con_tit">게시판관리 &gt; 자료실</div>
<div class="conBox">
