			...
			<tr>
				...
				<td>
					<c:if test="${list.yak_status eq 'y' }">
						<a href="#" class="popYajaeChangeBtn" attr0="${list.yak_name}" attr1="${list.yak_status}" attr2="${list.yak_from}" attr3="${list.yak_danga}" attr4="${list.seqno}" attr5="${list.yak_code}"><img src="/assets/user/pc/images/sub/btn_sel.png" alt="선택" /></a>
					</c:if>
				</td>
			</tr>		
		</c:forEach>
