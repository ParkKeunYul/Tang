...
<script type="text/javascript" src="/assets/user/pc/js/jquery.js"></script>
<script type="text/javascript" src="/assets/user/pc/js/cloud-zoom.1.0.2.min.js"></script>
<!-- container -->
<script>
...
<div class="contents">
	...
	<div class="product_view">
		<form action="01_add_order.do" name="frm" id="frm" method="post" >
			...
			<!-- 상단 상품정보 -->
			<div class="infoArea">
					<!-- <p><img src="#" id="title_img" width="400" height="250" alt="" /></p> -->
					<div class="zoom-section">
						<div class="zoom-small-image">
							<c:if test="${not empty view.image }">
								<a href="/upload/goods/${view.image }" class="cloud-zoom" id="zoom1" rel="adjustX:10, adjustY:-31, zoomWidth:525, zoomHeight:420"><img src="/upload/goods/${view.image }" alt=''  style="width: 400px;height: 301px;"/></a>
							</c:if>
						</div>
						<div class="zoom-desc">
							<c:if test="${not empty view.image }">
								<p><a href="/upload/goods/${view.image }" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '/upload/goods/${view.image }' "><img class="zoom-tiny-image m0" src="/upload/goods/${view.image }" alt = "Thumbnail 1"/></a>
							</c:if>
							<c:if test="${not empty view.image2 }">
								<a href="/upload/goods/${view.image2 }" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '/upload/goods/${view.image2 }'"><img class="zoom-tiny-image" src="/upload/goods/${view.image2 }" alt = "Thumbnail 2"/></a>
							</c:if>
							<c:if test="${not empty view.image3 }">
								<a href="/upload/goods/${view.image3}" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '/upload/goods/${view.image3}' "><img class="zoom-tiny-image" src="/upload/goods/${view.image3}" alt = "Thumbnail 3"/></a></p>
							</c:if>
						</div>
					</div>
