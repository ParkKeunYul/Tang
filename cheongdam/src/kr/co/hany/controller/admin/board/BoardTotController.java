...
import kr.co.nicevan.pg.common.mail.MailSendBean;
...
public class BoardTotController extends AdminDefaultController{
	...
	public String add( Map<String, Object> map
		...
		try{
			...
			AdminBoardUtil ab = new AdminBoardUtil(board_name);
	...
	public @ResponseBody Map<String, Object> mod_proc( Map<String, Object> map
		...
		try {
			...
			if("qna".equals(board_name)) {
				try {
					if(!"".equals(param.getString("email")) && "y".equals(param.getString("email_send")) && "y".equals(param.getString("re_com")) ) {
						MailSend.sendMail(param);
					}
				}catch (Exception e) {
					e.printStackTrace();
				}
