...
<%@taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
	...
	<style>
		.popup .tit{
			background : url('/assets/user/pc/images/sub/bg_popuptit.png') no-repeat left;				
		}
	...
	<div class="popup">
		<p class="tit">
			<span style="display: inline-block;padding-left: 50px;">최근 배송정보 검색</span>
			
			<a href="#" id="latelyCloseBtn" class="pop_closeBtn"><img src="/assets/user/pc/images/sub/btn_close01.png" alt="닫기" /></a>
		</p>
		<div class="topA">
