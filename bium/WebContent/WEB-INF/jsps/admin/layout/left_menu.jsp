...
<ul class="leftMenu">
	...
	<c:if test="${menu.fmenu eq 5}">
		...
		-->
		<li><a href="/admin/item/goods/slist.do">약속처방(가맹점) 상품관리</a></li>
	...
	<c:if test="${menu.fmenu eq 6}">
		...
		<!-- 
		<li><a href="/admin/board/paper/list.do">비움환 자료실</a></li>
		<li><a href="/admin/board/statis/list.do">치험례 · 논문</a></li>
		 -->
		<li><a href="/admin/board/paper/list.do">비움환 자료실</a></li>
		<li><a href="/admin/board/statis/list.do">치험례 · 논문</a></li>
