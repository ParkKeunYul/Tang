				...
				<tr>
					...
					<td>
						<c:if test="${not empty info.deliveryno  }">
							...
							<font class="b">송장번호 : ${info.deliveryno} (${info.tak_sel_nm}) </font><a href="https://tracker.delivery/#/${info.tak_sel_id}/${info.deliveryno}" class="deleberyBtn"><span class="cO h23">조회</span></a>
						</c:if>
					</td>
				</tr>
			</tbody>
