$(document).ready(function() {
  	...
  	$("#jqGrid").jqGrid({
  		...
  		colNames:[
  			'순번'    , '경로'  ,'주문번호' , '상품명'   , '주문자' , 
  			'등급'    ,'한의원명'  ,'수취인' , '금액'    , '포인트사용'  ,'입금'   ,
  			'결제방법' ,'계산서'  ,'주문일'   , '상태'    ,'송장'  , 
  			'메세지'  , 'tot_cnt' ,'cancel_ing' , 'tak_sel_id'  , '알림톡 발송번호' , 
  			'temple_no','order_handphone','delivery_date2' , '알림톡 발송여부'
  		],
  		colModel:[
  			...
  			{name:'use_point',		index:'use_point',		width:70,	align:"right"   ,sortable : false,
  				formatter: 'integer', 
  				formatoptions:{thousandsSeparator:","}
  			},
