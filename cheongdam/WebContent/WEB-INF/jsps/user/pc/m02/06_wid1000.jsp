...
<style>
	...
	.LArea .orderlist03 .comment01{
		width: 320px;
	}
	
	
	.LArea .orderlist03 tbody tr th{
...
<!-- 
		<ul class="sub_Menu">
			<li style="width: 156.59px;"><a href="01.do">처방하기</a></li>
			<li class="sel" ><a href="06.do">실속처방</a></li>
		...
		<div id="contents_order">
			...
			<div class="LArea">
				...
				<table class="orderlist01">
					...
					<tbody>
						...
						<tr>
							<th class="pb20">증상</th>
							<td class="pb20">
								<textarea name="w_contents" id="w_contents"  style="width:300px; height:50px;resize:none;">${setting.w_contents }</textarea>
							</td>
						</tr>
					</tbody>
				</table>
				...
				<div class="oderlist_top">
					<p><span>처방명</span><input type="text" name="s_name" id="s_name" value="${setting.s_name }" disabled="disabled" style="width:340px;margin-left:10px;" /></p>
					...
					<tbody>
						<tr>
							...
							<td>
								...
								<textarea name="c_joje_contents" id="c_joje_contents" class="textop" style="width:350px;" >${setting.c_joje_contents}</textarea>
							</td>
						</tr>
						...
						<tr>
							...
							<td style="padding-bottom:30px;">
								...
								<textarea name="c_bokyong_contents" id="c_bokyong_contents" class="textop" style="width:350px;">${setting.c_bokyong_contents}</textarea>
							</td>
						</tr>
