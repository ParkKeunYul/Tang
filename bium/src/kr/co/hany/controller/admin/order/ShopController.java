...
public class ShopController extends AdminDefaultController{
	...
	@RequestMapping ("view_print.do")
	public String view_print( Map<String, Object> map
							 ,HttpServletResponse response
							 ,HttpSession session){
		...
		return "/order/shop_print"+Const.uaTiles;
	}
...
//			shopDao.del_cart(param);
	...
	public  void gridExcelDown( Map<String, Object> map
						  	   ,HttpServletResponse response
						  	   ,HttpSession session){
		try{
			
			String data      = param.getString("csvBuffer", "");
	...
	/*		String header = request.getHeader("User-Agent");
			...
			*/
			...
			if(!"".equals(data)) {
				...
				response.setHeader("Content-Disposition", "attachment;filename=excel_"+sdf.format(today)+".xls");
	...
	@RequestMapping ("cms_cancel.do")
	public @ResponseBody Map<String, Object> cms_cancel( Map<String, Object> map
					  		 					 		,HttpServletResponse response
					  		 					 		 ,HttpSession session){
		Map<String, Object> rtn = PageUtil.procSet();
		try{
