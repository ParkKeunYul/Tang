...
<script type="text/javascript" src="/assets/user/js/tangOrderGrid.js"></script>
	...
	<div id="contents_order" style="margin-bottom: 150px;">
				...
				<table class="orderlist02">
					...
					<tfoot>
						<tr>
							<td colspan="3">
								<div>
									<a href="#" id="delItemBtn"><span class="cBB h30">선택 삭제</span></a>
								</div>
							</td>
							<td class="b">소개</td>
		...
		<div class="RArea">
			...
			<div class="btn_area05">
				<a href="04.do?page=${bean.page}&search_title=${bean.search_title}&search_value=${bean.encodeSV}"><span class="cw h50">취소</span></a>
