		...
		<tbody>
			...
			<tr>
				...
				<td class="tdL">
					...
					<option value="n" <c:if test="${info.notice_yn eq 'n' }">selected="selected"</c:if>>공지안함</option>
					<option value="y" <c:if test="${info.notice_yn eq 'y' }">selected="selected"</c:if>>공지함</option>
				</select>
				</td>
			</tr>
			<tr>
