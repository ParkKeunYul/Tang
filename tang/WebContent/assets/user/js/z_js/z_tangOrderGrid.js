...
$(document).ready(function() {
	...
	$("#jqGrid").jqGrid({
  		...
  		colModel:[
  			...
  			{name:'sort_seq_temp'         ,index:'sort_seq_temp'   ,width:30,	align:"center" 	,sortable : false ,editable:false  },
  					...
  					,dataEvents: [{
	  		            ...
	  		            fn: function(e) {
	  		                ...
	  		                if (key == 9){					  		                	
	  		                	setTimeout(function () {			  	
	  		                		if(selIRow+1 > tot){
	  		                			$('#jqGrid').editCell(1,  6 , true);
										console.log('selIRow1 = ', selIRow);
										return false;
	  		                		}else{
	  		                			$('#jqGrid').editCell(selIRow+1,  6 , true);	
										console.log('selIRow1 = ', selIRow);
										return false;
	  		                		}	  		                		
	  		                  	},50);	
