...
public class Const {
	...
	public static String mTiles  = ".m";
	public static String mmTiles = ".mp";
...
//	public static String DOMAIN = "http://localhost";
	...
	// 기본 디렉토리
	/*
	public static String UPLOAD_ROOT   = "C:/workspace_extjs/bium/WebContent/upload/";
	public static String FILEURL        = "http://localhost/upload";
	*/
	public static String UPLOAD_ROOT   = "/www/biumherb_co_kr/www/upload/";
	public static String FILEURL        = "http://bium.gabia.io/upload";
    ...
    /*
 	public static String NP_encodeKey = "EYzu8jGGMfqaDEp76gSckuvnaHHu+bC4opsSN6lHv3b2lurNYkVXrZ7Z1AoqQnXI3eLuaUFyoRNC6FkrzVjceg=="; 
   	...
   	public static String NP_CMS_encodeKey = "xqVH8KYzcJgWiYSjIaIM4LBE5+MYpncLeveB7RqHApwdI1BUbPXaLzOqnZqLtw4M1Sb3B7mwkfQ31vdgGOSf+Q=="; 
   	public static String NP_CMS_MID       = "payutest0m";
    */
    
    
    public static String NP_encodeKey     = "H5kJfI4uUcWAq8sRWeKv668I/E1M64H2lW+cm1RNZ1ezyqJsL1bIUHnxN4pwZV7b9s+KAWWW/YGlFGOG7PP5bQ==";
    public static String NP_MID           = "biumher11m";
    public static String NP_CMS_encodeKey = "beoYbMzOmawD+NsKobAJD7MbqrcBxVT406HBpSXrENX+XKXepFs1dA5fy1B3T5Fc+HpaDQ2VV9rYD60Ju/Lsug==";    										 
   	public static String NP_CMS_MID       = "biumherb1m";
   	
   	
    public static String NP_moid      = "bium";    
    ...
    public static String DOMAIN_NM    = "bium";
    
   
    public static String M_DOMAIN_NM    = "m.bium.com";
    //public static String M_DOMAIN_NM    = "m.cdherb.comm";
    //public static String M_DOMAIN_NM    = "192.168.0.6";
    /*
    
    */
    
    public static String KAKAO_AUTH   = "9VSTd1XwxP72LDB8QzNQ5nINKBVEahed5kvkMgJws6Y=";
    public static String KAKAO_TEMPLE = "17677";
