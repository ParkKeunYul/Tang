	...
	<div id="contents">
		...
		<div class="conArea">
			...
			<div class="topinfo">
				...
				<div class="ml20" style="min-height: 200px;">
					<p>결제정보</p>
					<ul>
			...
			<div class="topinfo">
				...
				<div class="ml20"  style="min-height: 300px;">
					<p>
						받는 사람
						<span class="fc01_t b">
							<c:choose>
		...
		<%-- 	<table class="order_view">
			...
			<div class="totalBox" style="margin-top:-1px;">
				<ul>
					<li class="tit">결제안내<span class="fc01_t">(${info.payment_kind_nm})</span></li>
					<c:choose>
			...
			<div class="dictionary_popup" style="width: 100%;margin-top: 20px;display: none;">
				...
				<table class="view02" style="width: 100%;">
					<colgroup>
						<col width="*" />
						<col width="160px" />
						<col width="100px" />
