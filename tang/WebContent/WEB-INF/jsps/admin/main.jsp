...
%>
<script type="text/javascript" src="/assets/admin/js/main.js?1"> </script>
<style>
	h2.menuTab{
		position: relative;
	}
...
<div id="warp">
	<div id="headerWr">
		<div class="header">
			...
			<ul class="gnb">		
				...
				<li><a href="/admin/total/inven/list.do">통계</a></li>
	...
	<div id="container" style="">
		...
		<div class="tang" style="padding: 10px 15px 0 15px;">
			<h2 class="mtit"><span>&sdot; 탕전 주문내역</span><a href="/admin/order/tang/list.do">더보기</a></h2>
			<table id="tangGrid"></table>			
			<div id="tang_form"></div>
		</div>
