	...
	<div id="contents">
		...
		<div class="searchArea">
			...
			<table>
				...
				<tr>
					<td colspan="3">
						조회기간 <input type="text" name="s_order_date" id="s_order_date"  value="${bean.s_order_date }" readonly="readonly"  style="width:115px; margin-left:10px;height: 34px;" class="date" /><a href="#" id="sdateBtn"><span class="cal"></span></a> 
						<span class="ml10">~</span>
						<input type="text" name="e_order_date" id="e_order_date" value="${bean.e_order_date }"  readonly="readonly"  style="width:115px; margin-left:10px;height: 34px;"  class="date"/><a href="#" id="edateBtn"><span class="cal"></span></a>
				...
				<tr>
					...
					<td>
						<input type="text" name="search_value" id="search_value"  value="${bean.search_value }" placeholder="처방명 또는 상품명을 입력해주세요." style="width:230px;height: 34px;" /><a href="#" id="searchBtn"><span class="cB h33">검색</span></a>
					</td>
				</tr>
			</table>
			</form>
		...
		<table class="myorder_list">
			...
			<tbody>
							...
							<span class="fc01">
								<c:choose>
									<c:when test="${list.order_type eq 1 }">
										...
										<c:if test="${list.payment eq 2}"><span class="fc01_t">미입금</span></c:if>
				...
				<%-- <tr>
					<td>2019-10-12</td>
					<td class="L"><a href="02_view.do">사향 공진당(사향 30mg=0.03g)</a></td>
					<td class="R">144,400원</td>
					<td>무통장</td>
					<td><span class="fc04">미입금</span></td>
					<td>주문처리중</td>
					<td>-</td>
					<td>-</td>
					<td><a href="#"><span class="cB h23">취소</span></a></td>
				</tr> --%>
