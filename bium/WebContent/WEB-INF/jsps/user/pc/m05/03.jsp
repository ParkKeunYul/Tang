...
<div class="contents">
	...
	<div class="searchArea">
		...
		<table>
			...
			<tr>
				<td colspan="2">
					<select name="search_sale" id="search_sale"  style="margin-left: 0px; margin-right: 5px;">
						<option value="">전체</option>	
						<option value="1"  <c:if test="${bean.search_sale eq 1 }">selected="selected"</c:if> >일반</option>
						<option value="2"  <c:if test="${bean.search_sale eq 2 }">selected="selected"</c:if>>가맹점</option>
					</select>
				...
				<tr>
					...
					<td>
						<c:if test="${not empty list.delivery_no  }">
							<a href="http://www.deliverytracking.kr/?dummy=dummy&deliverytype=lotteglogis&keyword=${list.delivery_no}&remark=" class="deleberyBtn"><span class="cO h23">조회</span></a>
						</c:if>
					</td>
					<td>
