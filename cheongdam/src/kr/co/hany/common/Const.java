...
//	public static String DOMAIN = "http://localhost";
	...
	// 기본 디렉토리
	public static String UPLOAD_ROOT   = "C:/workspace_extjs/cheongdam/WebContent/upload/";
	public static String FILEURL        = "http://localhost/upload";
	
	/*
	public static String UPLOAD_ROOT   = "/www/cdherb_com/www/upload/";
	public static String FILEURL        = "http://cdherb.com/upload";
*/
    ...
    public static int A_DELIVERY_PRICE  = 2500;
    ...
    /*테스트*/
 	public static String NP_encodeKey = "EYzu8jGGMfqaDEp76gSckuvnaHHu+bC4opsSN6lHv3b2lurNYkVXrZ7Z1AoqQnXI3eLuaUFyoRNC6FkrzVjceg=="; 
   	...
   	/*실*/
    /*
    public static String NP_encodeKey = "SRwpoEGNPEcpPy1qVgA4inAvfyvJQNRcIC/CuHUFepS0D9iIxM77E2PaDEobYrCiK1wweaKG81+7o9n2A6XQzA==";
    public static String NP_MID       = "cdherb111m";
    */
    public static String NP_moid      = "cheongdam";    
    ...
    public static String DOMAIN_NM    = "cheongdam";
    
   
    //public static String M_DOMAIN_NM    = "m.cdherb.com";
   /* public static String M_DOMAIN_NM    = "m.cdherb.comm";*/
    public static String M_DOMAIN_NM    = "192.168.219.156";
}
