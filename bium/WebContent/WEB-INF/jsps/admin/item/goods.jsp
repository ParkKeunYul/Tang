...
<script type="text/javascript" src="/assets/admin/js/jsp/item/goods.js?${toDay}"> </script>  
<%--  
 <script type="text/javascript" src="/assets/admin/js/zjsp/item/z_goods.js?${toDay}"> </script>
--%> 
