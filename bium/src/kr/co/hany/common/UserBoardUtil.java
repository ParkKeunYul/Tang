...
public class UserBoardUtil {
	...
	public Map<String, Object> list( Map<String, Object> map
		...
		try{
			...
			//페이징처리 
			if("m".equals(mtype)) {
				map.put("navi", PageUtil.getM_PageMysql(list, param, listCount, lastCount, listPage));
			}else {
				map.put("navi", PageUtil.getPageMysql(list, param, listCount, lastCount, listPage));
			}
			
			
			map.put("nlist", boardDAO.nlist(param));
	...
	public Map<String, Object> view(  Map<String, Object> map
		...
		try{
			...
			if(view == null || view.isEmpty()){
				...
				PageUtil.scripAlertBack(response, "게시물 정보가 없습니다.");
