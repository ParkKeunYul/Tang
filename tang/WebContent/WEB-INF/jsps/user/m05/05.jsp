		...
		<div class="conArea">
			<div class="searchBox01">
				<form action="" name="search_frm" id="search_frm" method="get">
					...
					<label><input type="radio" name="search_type"  value="name" checked> 처방환자</label>
					<label><input type="radio" name="search_type"  value="all"> 전체 </label>
					<div class="winput">
						<input type="text" name="search_value" id="search_value" value="${bean.search_value}" style="width:200px;" />
						<a href="#" id="searchBtn"><img src="/assets/user/images/common/bg_search.png" alt="검색" class="mt8" /></a>
					</div>
				...
				<tbody>
					<c:forEach var="list" items="${list}">
						<tr>
							...
							<td><a href="05_view.do?seqno=${list.seqno}&page=${bean.page}&search_title=${bean.search_title}&search_value=${bean.encodeSV}" class="li">${list.name}</a></td>
							<td>${list.sex}</td>
							...
							<td>
								...
								<c:if test="${empty list.last_order}">
									<!-- 삭제가능 -->
									<a href="#" class="pdelBtn" attr1='${list.seqno }'><span class="cBB h30">삭제</span></a>
								</c:if>
