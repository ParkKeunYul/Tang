...
<body style="margin: 0 0; padding: 0 0;">
	<div style="width: 789px;height: 505px;margin: 0 0; padding: 0 0;">
		<div  style="display: none;">
			<form action="02_order_com_cart_ajax.do" name="frm" id="frm" >
				...
				사용포인트 : <input type="text" name="use_point" value="${bean.use_point}" /><br/>
				포인트 사용내역 : <input type="text" name="reason" id="reason" value="${bean.reason}" /><br/>
